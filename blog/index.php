...
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="diabetes">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__does-bariatric-surgery-cure-type-2-diabetes.php">Does Bariatric Surgery Cure Type 2 Diabetes?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        ...
                        <a href="/blog/pages/blog__does-bariatric-surgery-cure-type-2-diabetes.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__what-is-the-minimum-weight-for-bariatric-surgery.php">What is the Minimum Weight for Bariatric Surgery?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__what-is-the-minimum-weight-for-bariatric-surgery.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="weight-loss">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__are-weight-loss-injections-safe.php">Are Weight Loss Injections Safe? {Complete Guide}</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__are-weight-loss-injections-safe.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__how-do-you-lose-weight-after-bariatric-surgery.php">How Do You Lose Weight After Bariatric Surgery?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__how-do-you-lose-weight-after-bariatric-surgery.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="weight-loss">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__is-ozempic-used-for-weight-loss.php">Is Ozempic Used for Weight Loss? {Key Insights}</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__is-ozempic-used-for-weight-loss.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__does-bariatric-surgery-lower-blood-pressure.php">Does Bariatric Surgery Lower Blood Pressure?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__does-bariatric-surgery-lower-blood-pressure.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__how-does-gastric-bypass-work.php">How Does Gastric Bypass Work?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__how-does-gastric-bypass-work.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__when-is-bariatric-surgery-recommended.php">When is Bariatric Surgery Recommended?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__when-is-bariatric-surgery-recommended.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="diabetes">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__can-bariatric-surgery-reverse-diabetes.php">Can Bariatric Surgery Reverse Diabetes?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__can-bariatric-surgery-reverse-diabetes.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__top-10-bariatric-surgeons-in-delhi.php">Top 10 Bariatric Surgeons in Delhi</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__top-10-bariatric-surgeons-in-delhi.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="laparoscopic">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__how-long-does-laparoscopic-appendectomy-surgery-take.php">How Long Does Laparoscopic Appendectomy Surgery Take?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__how-long-does-laparoscopic-appendectomy-surgery-take.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="laparoscopic">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/pages/blog__how-long-is-robotic-gallbladder-surgery.php">How Long is Robotic Gallbladder Surgery?</a>
                    </h2>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/pages/blog__how-long-is-robotic-gallbladder-surgery.php" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 flex justify-center gap-2">
        ...
        <a href="/blog/pages/blog__page__2.php" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-scod hover:text-white hover:border-scod transition-colors font-semibold">2</a>
        <a href="/blog/pages/blog__page__3.php" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-scod hover:text-white hover:border-scod transition-colors font-semibold">3</a>
        <a href="/blog/pages/blog__page__2.php" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-scod hover:text-white hover:border-scod transition-colors">
