...
?>
    ...
    <main class="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Blog Card: How Long does Body Contouring last? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="body-contouring">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    ...
                    <img src="/blog/media/images/how-long-does-body-contouring-last.jpg" alt="How Long does Body Contouring last?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/how-long-does-body-contouring-last">How Long does Body Contouring last?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Discover how long body contouring results last, comparing surgical vs non-surgical procedures, fat cell biology, and expert tips to maintain your sculpted contours for life.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/how-long-does-body-contouring-last" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
            ...
            <!-- Blog Card: How to Sleep after Gallbladder Surgery? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="recovery">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Recovery Tips</div>
                    <img src="/blog/media/images/how-to-sleep-after-gallbladder-surgery.jpg" alt="How to Sleep after Gallbladder Surgery?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/how-to-sleep-after-gallbladder-surgery">How to Sleep after Gallbladder Surgery?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Learn how to sleep after gallbladder surgery safely. Discover best sleeping positions, when to sleep on side/right side, recovery tips, and expert surgical advice.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/how-to-sleep-after-gallbladder-surgery" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="recovery">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Recovery Tips</div>
                    <img src="/blog/media/images/how-to-gain-weight-after-gallbladder-surgery.jpg" alt="How to Gain Weight After Gallbladder Surgery?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/how-to-gain-weight-after-gallbladder-surgery">How to Gain Weight After Gallbladder Surgery?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Struggling with post-cholecystectomy weight loss? Learn how to gain weight after gallbladder surgery safely with nutrient-dense foods, diet tips, and expert advice.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/how-to-gain-weight-after-gallbladder-surgery" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: Is Laparoscopic Surgery Covered by Insurance? {In 2026} -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="laparoscopic">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Laparoscopic</div>
                    <img src="/blog/media/images/is-laparoscopic-surgery-covered-by-insurance.jpg" alt="Is Laparoscopic Surgery Covered by Insurance? {In 2026}" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/is-laparoscopic-surgery-covered-by-insurance">Is Laparoscopic Surgery Covered by Insurance? {In 2026}</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Discover if laparoscopic surgery is covered by health insurance in 2026, eligible surgeries, claim procedures, covered costs, and key FAQs.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/is-laparoscopic-surgery-covered-by-insurance" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: Does Bariatric Surgery Affect Pregnancy? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    ...
                    <img src="/blog/media/images/does-bariatric-surgery-affect-pregnancy.jpg" alt="Does Bariatric Surgery Affect Pregnancy?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/does-bariatric-surgery-affect-pregnancy">Does Bariatric Surgery Affect Pregnancy?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Discover how bariatric surgery affects pregnancy, fertility benefits, safe conception timelines, nutritional guidelines, and essential key facts.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/does-bariatric-surgery-affect-pregnancy" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: Can Bariatric Surgery Improve Lung Capacity? {Key Facts} -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Bariatric Surgery</div>
                    <img src="/blog/media/images/can-bariatric-surgery-improve-lung-capacity.png" alt="Can Bariatric Surgery Improve Lung Capacity? {Key Facts}" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/can-bariatric-surgery-improve-lung-capacity">Can Bariatric Surgery Improve Lung Capacity? {Key Facts}</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Discover how bariatric surgery improves lung capacity, reduces shortness of breath, treats sleep apnea, and boosts respiratory health.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/can-bariatric-surgery-improve-lung-capacity" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: बेरिएट्रिक सर्जरी: लक्षण और रिकवरी (Bariatric Surgery in Hindi) -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="bariatric-surgery">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Bariatric Surgery</div>
                    <img src="/blog/media/images/bariatric-surgery-in-hindi.png" alt="बेरिएट्रिक सर्जरी: लक्षण और रिकवरी (Bariatric Surgery in Hindi)" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/bariatric-surgery-in-hindi">बेरिएट्रिक सर्जरी: लक्षण और रिकवरी (Bariatric Surgery in Hindi)</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">बेरिएट्रिक सर्जरी क्या है, इसके लक्षण, अर्थ, रिकवरी प्रक्रिया और side effects की पूरी जानकारी हिंदी में जानें।</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/bariatric-surgery-in-hindi" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: What to Eat after Laparoscopic Surgery? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="laparoscopic">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Laparoscopic</div>
                    <img src="/blog/media/images/what-to-eat-after-laparoscopic-surgery.jpg" alt="What to Eat after Laparoscopic Surgery?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/what-to-eat-after-laparoscopic-surgery">What to Eat after Laparoscopic Surgery?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Discover what to eat after laparoscopic surgery with our complete phase-by-phase post-operative diet guide, food lists, recovery tips, and clinical advice.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/what-to-eat-after-laparoscopic-surgery" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: Can Umbilical Hernia Be Treated Without Surgery? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="laparoscopic">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    <div class="absolute top-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-600 uppercase tracking-wider border shadow-sm z-10">Laparoscopic</div>
                    <img src="/blog/media/images/can-umbilical-hernia-be-treated-without-surgery.jpg" alt="Can Umbilical Hernia Be Treated Without Surgery?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3 hover:text-scod transition-colors">
                        <a href="/blog/can-umbilical-hernia-be-treated-without-surgery">Can Umbilical Hernia Be Treated Without Surgery?</a>
                    </h2>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">Can an umbilical hernia be treated or cured without surgery? Discover non-surgical facts, home remedy myths, complications, and modern laparoscopic solutions.</p>
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/can-umbilical-hernia-be-treated-without-surgery" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
            ...
            <!-- Blog Card: Can B12 Injections Cause Weight Loss? -->
            <article class="blog-card bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1" data-category="weight-loss">
                <div class="relative aspect-video overflow-hidden bg-blue-50">
                    ...
                    <img src="/blog/media/images/can-b12-injections-cause-weight-loss.jpg" alt="Can B12 Injections Cause Weight Loss?" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-3 text-xs text-gray-400 font-semibold uppercase tracking-wider mb-4">
                        <i data-feather="calendar" class="w-3 h-3"></i>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">By SCOD Clinic</span>
                        <a href="/blog/can-b12-injections-cause-weight-loss" class="flex items-center gap-2 text-scod text-sm font-semibold hover:text-blue-700 transition-colors">
                            Read More
                            <i data-feather="arrow-right" class="w-4 h-4"></i>
                        </a>
                    </div>
