...
<head>
    ...
    <title>Best Laparoscopic Surgeon in Delhi NCR | Dr. Arush Sabharwal</title>
    <meta name="description"
        content="Seeking the best laparoscopic surgeon in Delhi NCR? Dr. Arush Sabharwal offers advanced minimally invasive surgery, faster recovery, and expert care.">
...
<body class="min-h-screen bg-white text-gray-900 pt-20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-2xl observe-animate" data-animation="fade-in-left">
                <div
                    ...
                    <span class="text-sm font-bold tracking-wide uppercase">General & Advanced Surgery</span>
                </div>
                <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight text-white">Advanced <br> <span
                        class="text-emerald-300">Laparoscopic Surgery</span></h1>
                <p class="text-lg md:text-xl text-blue-100 mb-8 leading-relaxed font-light">Minimally invasive solutions
                    for hernias, gallstones, and abdominal conditions. Faster recovery, less pain, and minimal scarring.
                </p>
                <div class="flex flex-col sm:flex-row gap-5">
                    ...
                    <a href="tel:+918130130489"
                        class="bg-transparent border-2 border-white/30 backdrop-blur-sm text-white px-8 py-3 rounded-full font-bold text-base hover:bg-white/10 transition-all flex items-center justify-center space-x-2"><i
                            data-feather="phone" class="w-5 h-5"></i><span>Emergency: Call Us</span></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="observe-animate" data-animation="fade-in-left">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="h-px w-10 bg-scod"></div><span
                            class="uppercase tracking-widest text-sm font-bold text-scod">Technology</span>
                    </div>
                    <h2 class="text-4xl font-bold text-gray-900 mb-6 leading-tight">What is <br><span
                            class="text-scod">Laparoscopic Surgery?</span></h2>
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">Often called "Keyhole Surgery," laparoscopic
                        surgery is a modern technique where operations are performed through small incisions (usually
                        0.5–1.5 cm) far from the location.</p>
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">Using a high-definition camera (laparoscope)
                        and specialized precision instruments, Dr. Arush Sabharwal can perform complex procedures with
                        enhanced vision and control, without the need for large open incisions.</p>
                    <div class="flex flex-col space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900">Reduced Pain</h4>
                                <p class="text-sm text-gray-500">Significantly less post-operative discomfort.</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900">Faster Recovery</h4>
                                <p class="text-sm text-gray-500">Return to work and daily life much sooner.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- COMMON PROCEDURES TABS -->
    <section class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <span class="uppercase tracking-widest text-sm font-bold text-scod">Our Expertise</span>
                <h2 class="text-4xl font-bold text-gray-900 mt-2">Common Procedures</h2>
            </div>
            <div class="flex flex-wrap justify-center gap-4 mb-10">
                <button
                    class="procedure-tab px-6 py-3 rounded-full font-bold text-sm md:text-base transition-all duration-300 shadow-sm border-2 bg-scod text-white border-scod shadow-lg scale-105"
                    data-tab="gallbladder">Gallbladder</button>
                <button
                    class="procedure-tab px-6 py-3 rounded-full font-bold text-sm md:text-base transition-all duration-300 shadow-sm border-2 bg-white text-gray-600 border-gray-100 hover:border-scod hover:text-scod"
                    data-tab="hernia">Hernia Repair</button>
                <button
                    class="procedure-tab px-6 py-3 rounded-full font-bold text-sm md:text-base transition-all duration-300 shadow-sm border-2 bg-white text-gray-600 border-gray-100 hover:border-scod hover:text-scod"
                    data-tab="appendix">Appendix</button>
                <button
                    class="procedure-tab px-6 py-3 rounded-full font-bold text-sm md:text-base transition-all duration-300 shadow-sm border-2 bg-white text-gray-600 border-gray-100 hover:border-scod hover:text-scod"
                    data-tab="reflux">Anti-Reflux</button>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7">
                    ...
                    <h3 class="text-xl text-gray-500 font-medium mb-8 border-l-4 border-scod pl-4">Chairman & Chief
                        Surgeon, SCOD</h3>
                    <p class="text-gray-600 leading-relaxed mb-6 text-lg">Dr. Arush Sabharwal is a globally recognized
                        pioneer in Minimal Access Surgery. He specializes in advanced laparoscopic procedures, ensuring
                        faster recovery and minimal scarring for his patients.</p>
                    <blockquote class="text-xl font-medium text-gray-800 italic mb-8 relative z-10">"Precision in
                        surgery translates to quality of life for the patient. My goal is to get you back to your
                        routine as safely and quickly as possible."</blockquote>
                    <a href="../about.php"
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-red-50 border-l-8 border-red-500 rounded-r-2xl p-8 md:p-12 shadow-sm observe-animate"
                data-animation="scale-in">
                <div class="flex flex-col md:flex-row items-start gap-6">
                    <div class="bg-red-100 p-4 rounded-full text-red-600 flex-shrink-0"><i data-feather="alert-triangle"
                            class="w-8 h-8"></i></div>
                    <div>
                        <h3 class="text-2xl font-bold text-red-700 mb-4">When to seek Emergency Care?</h3>
                        <p class="text-gray-700 mb-6 text-lg">Some abdominal conditions require immediate attention. Do
                            not delay if you experience:</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <ul class="space-y-2">
                                <li class="flex items-center text-gray-800 font-medium"><span
                                        class="w-2 h-2 bg-red-400 rounded-full mr-3"></span>Sudden, severe abdominal
                                    pain</li>
                                <li class="flex items-center text-gray-800 font-medium"><span
                                        class="w-2 h-2 bg-red-400 rounded-full mr-3"></span>Persistent vomiting</li>
                                <li class="flex items-center text-gray-800 font-medium"><span
                                        class="w-2 h-2 bg-red-400 rounded-full mr-3"></span>High fever with chills</li>
                            </ul>
                        </div>
                        <a href="tel:+918130130489"
                            class="inline-flex items-center space-x-2 bg-red-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-red-700 transition-colors"><i
                                data-feather="phone" class="w-5 h-5"></i><span>Call Emergency Services or Visit
                                ER</span></a>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900">General <span class="text-scod">FAQs</span></h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div>
                    <h2 class="text-4xl font-bold text-gray-900 mb-6">Schedule Your <br><span
                            class="text-scod">Surgery</span></h2>
                    <p class="text-xl text-gray-600 mb-8 leading-relaxed">Whether it's a planned hernia repair or a
                        gallstone consultation, our expert team ensures your safety and comfort.</p>
                    <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    <form class="space-y-4">
                        ...
                        <div><label class="block text-sm font-medium text-gray-700 mb-1">Condition /
                                Procedure</label><textarea rows="3"
    ...
    <script>
        ...
        const generalFaqs = [
            { q: "What does 'Laparoscopic' mean?", a: "Laparoscopic surgery, also known as minimally invasive or keyhole surgery, uses a specialized instrument called a laparoscope (a thin tube with a camera). This allows the surgeon to see inside the body and perform operations through very small incisions (0.5-1 cm) rather than large cuts." },
            { q: "Is general anesthesia required?", a: "Yes, laparoscopic procedures are performed under general anesthesia, meaning you will be completely asleep and pain-free during the surgery." },
            { q: "Will I have big scars?", a: "No. One of the main benefits is cosmetic. The incisions are very small, often requiring only a single stitch or surgical glue, leaving barely visible scars once healed." },
            { q: "When can I drive after surgery?", a: "Typically, you can resume driving once you are off prescription pain medication and can perform emergency maneuvers without pain, usually 3-5 days post-surgery." },
            { q: "Do I need a special diet?", a: "For most general laparoscopic procedures (like gallbladder or hernia), a light, liquid-based diet is recommended for the first 24 hours, advancing to soft foods as tolerated. Anti-reflux surgery requires a specific soft diet for several weeks." },
            { q: "How is pain managed?", a: "Pain is generally mild compared to open surgery. We use a multimodal approach including local anesthesia at incision sites and oral pain relievers for a few days." },
            { q: "Can I shower after surgery?", a: "Yes, you can typically shower 24-48 hours after surgery. We use waterproof dressings or surgical glue that allows for gentle washing." }
        ];
        // Feather Icons
        feather.replace();
        // Slider State
        ...
        // 1. Render Testimonials Slider (Matches React Card Design)
        ...
        // 2. Render Awareness Slider (Matches React Card Design)
        ...
        function renderProcedure(key) {
            ...
            if (!container) return;
            container.innerHTML = `
                <div class="bg-white rounded-[2.5rem] p-8 md:p-10 border border-gray-100 shadow-xl animate-fadeIn">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <h4 class="text-lg font-bold text-gray-900 mb-2 flex items-center">
                                        <i data-feather="trending-up" class="w-5 h-5 text-scod mr-2"></i> Benefits of Laparoscopy
                                    </h4>
                        ...
                        <div class="flex flex-col h-full">
                            <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 h-64 mb-8 flex items-center justify-center relative group">
                                ...
                                <div class="absolute top-4 right-4 bg-scod text-white text-xs font-bold px-3 py-1 rounded-full">
                                    Minimally Invasive
                                </div>
                            </div>
                            <div class="bg-emerald-50 p-8 rounded-2xl border border-emerald-100 mb-4 flex-grow">
                                <h4 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                                    <i data-feather="clock" class="w-6 h-6 text-emerald-600 mr-2"></i> Recovery Expectations
                                </h4>
