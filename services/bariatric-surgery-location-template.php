...
<head>
    ...
    <title>Best Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> | Dr. Arush Sabharwal</title>
    <meta name="description"
        content="Seeking the best bariatric surgeon in <?php echo htmlspecialchars($location); ?>? Dr. Arush Sabharwal offers advanced weight loss surgery, safe procedures, and personalized bariatric care.">
    ...
    <link rel="canonical" href="https://scodclinic.com/bariatric-surgeon-in-<?php echo htmlspecialchars($slug); ?>" />
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "Dr. Arush Sabharwal: Bariatric Surgeon in <?php echo htmlspecialchars($location); ?>, India | Diabetes, Weight Loss, Body Contouring, Dietician in <?php echo htmlspecialchars($location); ?>",
  "image": "",
  "@id": "",
  "url": "",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Bariatric surgery is a medical procedure that helps people lose weight by changing the way the digestive system works. It reduces the size of the stomach or changes how food is absorbed, helping patients eat less and feel full sooner. Many people choose Bariatric Surgery in <?php echo htmlspecialchars($location); ?> to manage severe obesity and improve overall health."
    }
  },{
    "@type": "Question",
    "name": "Who is a good candidate for Bariatric Surgery?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Bariatric surgery is usually recommended for people with a Body Mass Index (BMI) above 40, or above 35 with obesity-related health conditions such as diabetes, high blood pressure, or sleep apnea."
    }
  },{
    "@type": "Question",
    "name": "How much weight can a person lose after Bariatric Surgery?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Most patients lose around 50–70% of their excess weight within the first 12–18 months after surgery. The exact results depend on the type of procedure, lifestyle changes, and follow-up care provided by a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?>."
    }
  },{
    "@type": "Question",
    "name": "Is Bariatric Surgery safe?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, bariatric surgery is generally considered safe when performed by an experienced and qualified surgeon. Choosing a specialist who performs Bariatric Surgery in <?php echo htmlspecialchars($location); ?> using modern surgical techniques can significantly reduce risks and improve outcomes."
    }
  },{
    "@type": "Question",
    "name": "How long does it take to recover after Bariatric Surgery?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Recovery time varies depending on the procedure and the patient’s overall health. Most patients can return to light activities within 1–2 weeks, while full recovery may take a few weeks. Proper guidance from a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> helps ensure a smooth recovery."
    }
  },{
    "@type": "Question",
    "name": "Will I need to follow a special diet after Bariatric Surgery?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, patients need to follow a structured diet plan after surgery. The diet usually starts with liquids and gradually progresses to soft and solid foods. Nutritional guidance is an important part of the recovery process after Bariatric Surgery in <?php echo htmlspecialchars($location); ?>."
    }
  },{
    "@type": "Question",
    "name": "Can Bariatric Surgery help improve other health conditions?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, bariatric surgery can significantly improve or even resolve several obesity-related conditions such as type 2 diabetes, high blood pressure, sleep apnea, and joint pain. Many patients undergoing Bariatric Surgery in <?php echo htmlspecialchars($location); ?> experience improved overall health and quality of life."
    }
  },{
    "@type": "Question",
    "name": "Why Dr. Arush Sabharwal is the Best Bariatric Surgeon in <?php echo htmlspecialchars($location); ?>?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Dr. Arush Sabharwal is recognized as a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> because of his extensive experience in treating obesity and performing advanced weight loss procedures. With more than 15 years of experience, he specializes in modern and minimally invasive techniques that support safe surgery and faster recovery."
    }
  }]
}
</script>
...
?>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-2xl observe-animate" data-animation="fade-in-left">
                ...
                <h1 class="text-4xl text-white md:text-6xl font-bold mb-6 leading-tight">Dr. Arush Sabharwal:<br><span
                        class="text-emerald-300">Bariatric Surgeon in <?php echo htmlspecialchars($location); ?></span></h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="observe-animate" data-animation="fade-in-left">
                    ...
                    <h2 class="text-4xl font-bold text-gray-900 mb-6 leading-tight">Understanding <br><span
                            class="text-scod">Bariatric Surgery</span></h2>
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">Bariatric surgery, often referred to as weight loss surgery, involves making changes to your digestive system to help you lose weight. It is not just about reducing the size of the stomach; it involves complex metabolic changes that affect hunger hormones and insulin sensitivity. Bariatric Surgery in <?php echo htmlspecialchars($location); ?> has become an advanced and widely available treatment option for people struggling with severe obesity and related health conditions.</p>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Bariatric Surgery in <?php echo htmlspecialchars($location); ?> is a life-saving medical intervention
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">Dr. Arush Sabharwal: Leading Bariatric Surgeon in <?php echo htmlspecialchars($location); ?></h2>
                    <h3 class="text-xl text-gray-500 font-medium mb-8 border-l-4 border-scod pl-4">Chairman & Chief
                        Surgeon, SCOD</h3>
                    <p class="text-gray-600 leading-relaxed mb-6 text-lg">Dr. Arush Sabharwal is a highly experienced Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> NCR with more than 15 years of expertise in the treatment of obesity and metabolic disorders. He specializes in advanced weight loss procedures designed to help patients achieve long-term and sustainable results. With a strong focus on safety, precision, and patient well-being, he has helped many individuals manage severe obesity and improve their overall health through modern bariatric treatments.
                    </p>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-600 mt-2">Real results from our bariatric surgery patients.</p>
            </div>
            <!-- Simple JS Gallery -->
    ...
    <section class="py-16 bg-white border-t border-gray-100" id="bariatric-surgery-near-me">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-3 max-w-2xl mx-auto">Explore top-rated bariatric surgery services and specialist consultations available across neighboring locations in Delhi NCR.</p>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                foreach ($all_locations as $loc_name => $loc_slug):
                    if ($loc_slug === $current_slug) continue;
                ?>
    ...
    { 
        ...
        a: "Bariatric surgery is a medical procedure that helps people lose weight by changing the way the digestive system works. It reduces the size of the stomach or changes how food is absorbed, helping patients eat less and feel full sooner. Many people choose Bariatric Surgery in <?php echo htmlspecialchars($location); ?> to manage severe obesity and improve overall health." 
    },
    { 
        q: "Who is a good candidate for Bariatric Surgery?", 
        a: "Bariatric surgery is usually recommended for people with a Body Mass Index (BMI) above 40, or above 35 with obesity-related health conditions such as diabetes, high blood pressure, or sleep apnea." 
    },
    { 
        q: "How much weight can a person lose after Bariatric Surgery?", 
        a: "Most patients lose around 50–70% of their excess weight within the first 12–18 months after surgery. The exact results depend on the type of procedure, lifestyle changes, and follow-up care provided by a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?>." 
    },
    { 
        q: "Is Bariatric Surgery safe?", 
        a: "Yes, bariatric surgery is generally considered safe when performed by an experienced and qualified surgeon. Choosing a specialist who performs Bariatric Surgery in <?php echo htmlspecialchars($location); ?> using modern surgical techniques can significantly reduce risks and improve outcomes." 
    },
    { 
        q: "How long does it take to recover after Bariatric Surgery?", 
        a: "Recovery time varies depending on the procedure and the patient’s overall health. Most patients can return to light activities within 1–2 weeks, while full recovery may take a few weeks. Proper guidance from a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> helps ensure a smooth recovery." 
    },
    { 
        q: "Will I need to follow a special diet after Bariatric Surgery?", 
        a: "Yes, patients need to follow a structured diet plan after surgery. The diet usually starts with liquids and gradually progresses to soft and solid foods. Nutritional guidance is an important part of the recovery process after Bariatric Surgery in <?php echo htmlspecialchars($location); ?>." 
    },
    { 
        q: "Can Bariatric Surgery help improve other health conditions?", 
        a: "Yes, bariatric surgery can significantly improve or even resolve several obesity-related conditions such as type 2 diabetes, high blood pressure, sleep apnea, and joint pain. Many patients undergoing Bariatric Surgery in <?php echo htmlspecialchars($location); ?> experience improved overall health and quality of life." 
    },
    { 
        q: "Why Dr. Arush Sabharwal is the Best Bariatric Surgeon in <?php echo htmlspecialchars($location); ?>?", 
        a: "Dr. Arush Sabharwal is recognized as a Top Bariatric Surgeon in <?php echo htmlspecialchars($location); ?> because of his extensive experience in treating obesity and performing advanced weight loss procedures. With more than 15 years of experience, he specializes in modern and minimally invasive techniques that support safe surgery and faster recovery." 
    }
];
        // Feather Icons
        feather.replace();
